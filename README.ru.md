...
Слой реактивной перцепции и роевой координации — отдельное **проприетарное** ядро, в этот репозиторий **не входит** (доступно по запросу).
...
Сотрудничество, пилотный проект или доступ к проприетарному роевому слою — пишите.
